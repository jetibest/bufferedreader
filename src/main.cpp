	...
	if(prefix)
	{
		if(verbose)
		{
			if(inclusive)
			{
				if(nostrip)
				{
					dobr<1, 1, 1, 1>(delimiter, separator1, separator2);
				}
				else
				{
					dobr<1, 1, 1, 0>(delimiter, separator1, separator2);
				}
			}
			else
			{
				if(nostrip)
				{
					dobr<1, 1, 0, 1>(delimiter, separator1, separator2);
				}
				else
				{
					dobr<1, 1, 0, 0>(delimiter, separator1, separator2);
				}
			}
		}
		else
		{
			if(inclusive)
			{
				if(nostrip)
				{
					dobr<1, 0, 1, 1>(delimiter, separator1, separator2);
				}
				else
				{
					dobr<1, 0, 1, 0>(delimiter, separator1, separator2);
				}
			}
			else
			{
				if(nostrip)
				{
					dobr<1, 0, 0, 1>(delimiter, separator1, separator2);
				}
				else
				{
					dobr<1, 0, 0, 0>(delimiter, separator1, separator2);
				}
			}
		}
	}
	else
	{
		if(verbose)
		{
			if(inclusive)
			{
				if(nostrip)
				{
					dobr<0, 1, 1, 1>(delimiter, separator1, separator2);
				}
				else
				{
					dobr<0, 1, 1, 0>(delimiter, separator1, separator2);
				}
			}
			else
			{
				if(nostrip)
				{
					dobr<0, 1, 0, 1>(delimiter, separator1, separator2);
				}
				else
				{
					dobr<0, 1, 0, 0>(delimiter, separator1, separator2);
				}
			}
		}
		else
		{
			if(inclusive)
			{
				if(nostrip)
				{
					dobr<0, 0, 1, 1>(delimiter, separator1, separator2);
				}
				else
				{
					dobr<0, 0, 1, 0>(delimiter, separator1, separator2);
				}
			}
			else
			{
				if(nostrip)
				{
					dobr<0, 0, 0, 1>(delimiter, separator1, separator2);
				}
				else
				{
					dobr<0, 0, 0, 0>(delimiter, separator1, separator2);
				}
			}
		}
	}
